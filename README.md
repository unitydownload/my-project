# my-project[nath.html](https://github.com/user-attachments/files/25596320/nath.html)
<!DOCTYPE html>
<html lang='en' >
<head>
  <meta charset='UTF-8'>
...
<div class='container'>
  ...
  <div class='trigger'></div>
  <div class='monitor'>
<div class="vr_text">hello world</div>
...
.vr_layer:nth-child(😎 .vr_layer_item {
...
.vr_text {
  ...
  text-align: center;
  pointer-events: none;
  animation: rotateText 5s linear infinite, blinkText 1s step-start infinite;
}

@keyframes rotateText {
  0% { transform: translate(-50%, -50%) rotateY(0deg) translateZ(0); }
  25% { transform: translate(-50%, -50%) rotateY(90deg) translateZ(0); }
  50% { transform: translate(-50%, -50%) rotateY(180deg) translateZ(0); }
  75% { transform: translate(-50%, -50%) rotateY(270deg) translateZ(0); }
...
</script>[nassrsdrfswerfg.html](https://github.com/user-attachments/files/25596323/nassrsdrfswerfg.html)
<!DOCTYPE html>
<html lang="tl">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Ninja Contact</title>
<style>
/* BODY + CENTERING */
body {
  margin:0;
...
.ninja .hair {
  width:120px;
  height:60px;
  background: linear-gradient(45deg,#ffcc00,#ffea00);
  clip-path: polygon(
...
@keyframes glow {
  0%,100% { filter: drop-shadow(0 0 15px orange); }
...
<div class="card">
  ...
  <h2>Ninja Contact</h2>
  <div class="number">📱 0912-345-6789</div>
  <button onclick="alert('Tinawag ang ninja!')">Tawag Ninja</button>
</div>[n9.html](https://github.com/user-attachments/files/25596325/n9.html)
<!DOCTYPE html>
<html>
<head>
...
Write to Nathaniel Diezmo[n2.html.html](https://github.com/user-attachments/files/25596326/n2.html.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
